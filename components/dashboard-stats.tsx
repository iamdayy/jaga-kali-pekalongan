...
export default function DashboardStats({ data }: DashboardStatsProps) {
  ...
  const severityData = [
    {
      name: "High",
      value: data.reportsBySeverity["high"] || 0,
      fill: "#dc2626",
    },
    {
      name: "Medium",
      value: data.reportsBySeverity["medium"] || 0,
      fill: "#eab308",
    },
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        ...
        <p className="text-3xl font-bold text-foreground mt-2">
          <CountUp start={0} end={data.totalReports} duration={5} />
        </p>
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        ...
        <p className="text-3xl font-bold text-yellow-600 mt-2">
          <CountUp start={0} end={data.pendingReports} duration={5} />
        </p>
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        ...
        <p className="text-3xl font-bold text-blue-600 mt-2">
          <CountUp start={0} end={data.inProgressReports} duration={5} />
        </p>
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        ...
        <p className="text-3xl font-bold text-green-600 mt-2">
          <CountUp start={0} end={data.completedReports} duration={5} />
        </p>
